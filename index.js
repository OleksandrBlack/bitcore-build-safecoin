...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-safecoin/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-safecoin -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-safecoin -o bitcore-lib-safecoin.js';
    }
